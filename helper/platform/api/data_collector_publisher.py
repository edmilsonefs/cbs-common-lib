...
from helper.platform.data_helper import PROJECT_ID, BASE_API_URL, unify_string
...
class DataCollectorPublisher:
    ...
    def get_issues(self, query):
        ...
        response = requests.get(
            BASE_API_URL + '/issue/v1/collections/' + PROJECT_ID + '/issues/?isDeleted=false&q=' + quote(str(unify_string(query))),
