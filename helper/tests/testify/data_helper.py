...
actual = 'set([\'{"status": "Fail", "profile": "AA Secure Omniture", "required": "livetv_available", "Name": "c. ' \
         'pageType", "value": "livetv_availability"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", ' \
         '"required": "livetv_available", "Name": "c. pageType", "value": "livetv"}\', \'{"status": "Fail", ' \
         '"profile": "AA Secure Omniture", "required": "/livetv/check availability", "Name": "c. screenName", ' \
         '"value": "/all access/upsell"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"/livetv/check availability", "Name": "pageName", "value": "/"}\', \'{"status": "Fail", "profile": "AA ' \
         'Secure Omniture", "required": "/livetv/check availability", "Name": "c. screenName", ' \
         '"value": "/settings/"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"livetv_available", "Name": "c. pageType", "value": "menu"}\', \'{"status": "Fail", "profile": "AA Secure ' \
         'Omniture", "required": "livetv|upsell|check availability", "Name": "c. siteHier", "value": "livetv"}\', ' \
         '\'{"status": "Fail", "profile": "AA Secure Omniture", "required": "livetv|upsell|check availability", ' \
         '"Name": "c. siteHier", "value": "menu|"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", ' \
         '"required": "livetv|upsell|check availability", "Name": "c. siteHier", "value": "all access|upsell"}\', ' \
         '\'{"status": "Fail", "profile": "AA Secure Omniture", "required": "/livetv/check availability", "Name": "c. ' \
         'screenName", "value": "/menu/home"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"livetv_available", "Name": "c. pageType", "value": "accounts_login"}\', \'{"status": "Fail", "profile": ' \
         '"AA Secure Omniture", "required": "/livetv/check availability", "Name": "pageName", ' \
         '"value": "/settings/"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"livetv|upsell|check availability", "Name": "c. siteHier", "value": "menu|home"}\', \'{"status": "Fail", ' \
         '"profile": "AA Secure Omniture", "required": "livetv|upsell|check availability", "Name": "c. siteHier", ' \
         '"value": "other|other|accounts|login"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"/livetv/check availability", "Name": "pageName", "value": "CBS 4.8.5 (1648548)"}\', \'{"status": "Fail", ' \
         '"profile": "AA Secure Omniture", "required": "cbsicbsapp", "Name": "c. sitePrimaryRsid", ' \
         '"value": "cnetcbscomsite"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"livetv_available", "Name": "c. pageType", "value": "settings"}\', \'{"status": "Fail", "profile": "AA ' \
         'Secure Omniture", "required": "livetv|upsell|check availability", "Name": "c. siteHier", ' \
         '"value": "other|other|settings|home"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"livetv_available", "Name": "c. pageType", "value": "svod_upsell"}\', \'{"status": "Fail", "profile": "AA ' \
         'Secure Omniture", "required": "/livetv/check availability", "Name": "c. screenName", ' \
         '"value": "/accounts/login"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"/livetv/check availability", "Name": "c. screenName", "value": "/login"}\', \'{"status": "Fail", ' \
         '"profile": "AA Secure Omniture", "required": "/livetv/check availability", "Name": "c. screenName", ' \
         '"value": "/livetv/"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"livetv_available", "Name": "c. pageType", "value": "front_door"}\', \'{"status": "Fail", "profile": "AA ' \
         'Secure Omniture", "required": "livetv|upsell|check availability", "Name": "c. siteHier", ' \
         '"value": "home"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": "/livetv/check ' \
         'availability", "Name": "c. screenName", "value": "/menu/live tv"}\', \'{"status": "Fail", "profile": "AA ' \
         'Secure Omniture", "required": "/livetv/check availability", "Name": "c. screenName", "value": "/"}\', ' \
         '\'{"status": "Fail", "profile": "AA Secure Omniture", "required": "/livetv/check availability", ' \
         '"Name": "pageName", "value": "/livetv/"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", ' \
         '"required": "/livetv/check availability", "Name": "pageName", "value": "/accounts/login"}\', \'{"status": ' \
         '"Fail", "profile": "AA Secure Omniture", "required": "livetv|upsell|check availability", "Name": "c. ' \
         'siteHier", "value": "menu|live tv"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": ' \
         '"/livetv/check availability", "Name": "c. screenName", "value": "/menu/"}\', \'{"status": "Fail", ' \
         '"profile": "AA Secure Omniture", "required": "livetv|upsell|check availability", "Name": "c. siteHier", ' \
         '"value": "splash"}\', \'{"status": "Fail", "profile": "AA Secure Omniture", "required": "/livetv/check ' \
         'availability", "Name": "pageName", "value": "/all access/upsell"}\'])'
